...
class BlinkingBorderedLabel(FlippedLabel):
    def __init__(self, text, border_color, parent=None):
        ...
        self.setStyleSheet(f" border: 1px solid {utils.DISPLAY_COLORS[utils.curr_color]}; padding: 5px;")
    ...
    def toggle_border(self):
        ...
        border_style = f"1px solid {utils.DISPLAY_COLORS[utils.curr_color]}" if self.border_visible else "0px"
        self.setStyleSheet(
            f"color: {utils.DISPLAY_COLORS[utils.curr_color]}; font-size: 15pt; font-family: Consolas; border: {border_style}; padding: 5px;")
